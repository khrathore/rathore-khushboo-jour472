...
```{r echo=FALSE}
census_api_key("4e2627391241d2d3419becb0abe8b0a8cffe8aab", install=TRUE)
```
...
**Answer** 
Howard County is decidedly the most wealthy county in Maryland
```{r}
md %>%
...
**Answer**
Baltimore City, Allegany County, Calvert County, and Frederick County had the largest increases. None of them had falling income.
```{r}
md10 %>%
...
**Answer**
Do areas with higher household income usually have more college-going students? Answers could get harder because some people go into the workforce or trade school, and many took gap years because of COVID. Some may have also gone to work. Also, the zip codes aren't necessarily where the students live. For example, I went to high school in 20901 but lived in 20878.
```{r}
...
**Answer**
The income is significantly higher in high schools with more immediate enrollments than those with fewer.
```{r}
...
**Answer** 
What are the demographics of each area and how does that relate to income and college attendee rates? I would also personally wonder about FRC teams and are students at schools where those exist being benefitted?