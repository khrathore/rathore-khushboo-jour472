...
**Answer**
The names are inconsistent for many of the grantees.
```{r}
...
**Answer**
Washington County Museum of Fine Arts was changed to all uppercase, Inc was removed from Charles County Arts Alliance and it was made fully uppercase.
```{r}
...
**Answer**
Washington Adventist University was changed to title case.
That was the only change I could find in the first 30.
```{r}
cleaned_md_grant_loans %>%
