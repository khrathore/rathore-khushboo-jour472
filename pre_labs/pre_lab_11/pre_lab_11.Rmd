...
**Answer** 
The date is a character type, there are no links to the actual releases. There are only two columns, which are titled based on the titles that are on the page.
```{r}
...
**Answer** 
I would want to add a link to the press release and maybe some kind of category for each of the press releases. Additionally, it may be good to have column about the county that the release relates to.
```{r}
...
**Answer** 
The output shows what information is beside the li tag, including the social medias, the main page navigators, and those that have the names of a press release.
```{r}
...
**Answer** 
No output, the resulting tibble is a list of all the text beside the list elements.
```{r}
