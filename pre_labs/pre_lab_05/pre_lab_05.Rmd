...
**Answer**
The headers are not what we want, there are a bunch of periods too.
```{r}
...
**Answer**
Nothing is labelled well, the area columns have a bunch of weird dots.
```{r}
...
**Answer**
The jurisdiction column still has weird dots and punctuation that makes standardization hard.
```{r}
